...
public abstract class Hilt_PokemonViewFragment<BINDING extends ViewDataBinding> extends BaseFragment<BINDING> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((PokemonViewFragment_GeneratedInjector) generatedComponent()).injectPokemonViewFragment(UnsafeCasts.<PokemonViewFragment>unsafeCast(this));
  }
