...
public abstract class Hilt_PokemonListFragment<BINDING extends ViewDataBinding> extends BaseFragment<BINDING> implements GeneratedComponentManager<Object> {
  ...
  protected void inject() {
    ((PokemonListFragment_GeneratedInjector) generatedComponent()).injectPokemonListFragment(UnsafeCasts.<PokemonListFragment>unsafeCast(this));
  }
